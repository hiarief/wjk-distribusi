...
class CreateKartuKeluargaAnggotasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_kartu_keluarga_anggota', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('t_kartu_keluarga_anggota');
    }
}