            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <a href="{{ route('siode.kependudukan.anggota-keluarga.create') }}"
                        ...
                        <tbody>
                            @forelse ($kartukeluargaanggota as $value => $fm)
                                <tr class="text-center">
                                    ...
                                    <td style="text-transform:uppercase">{{ $fm->kartukeluarga->kp }}, RT.
                                        {{ $fm->kartukeluarga->rt }}/{{ $fm->kartukeluarga->rw }}, DS.
