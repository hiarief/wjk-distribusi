            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <a href="{{ route('siode.kartu-keluarga.create') }}" class="btn btn-xs bg-gradient-primary"><i
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group text-center">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <form method="POST" action="{!! route('siode.kartu-keluarga.destroy', $fm->id) !!}" class="text-center">
                                                    @csrf
                                                    @method('delete')
                                                    <a class="dropdown-item bg-gradient-info"
                                                        href="{{ route('siode.kartu-keluarga.show', $fm->no_kk) }}"><i
                                                            class="fa-solid fa-eye"></i>
                                                        View</a>
                                                    <a class="dropdown-item bg-gradient-warning"
                                                        href="{{ route('siode.kartu-keluarga.edit', $fm->id) }}"><i
